...
public:
	...
	*/
	...
	void setBackfaceCulling(bool b);	///< Set wireframe render mode on/off
	bool getBackfaceCulling();		///< Returns currect wireframe state on/off
...
protected:
	...
	bool cullBackFaceState;	///< Variable tracks backface culling
	...
	ID3D11RasterizerState* rasterStateCullNone;		///< No culling raster state
